!(function (e, t) {
  ...
  class _ {
    ...
    static use(e) {
      return Array.isArray(e) ? (e.forEach((e) => _.installModule(e)), _) : (_.installModule(e), _);
    }
  }
  function F(e, t, s, i) {
    const r = a();
  ...
  document.addEventListener('DOMContentLoaded', () => {
    new Swiper('.steps-swiper', {
      ...
      pagination: {
        ...
        clickable: !0,
        renderBullet: (e, t) => `<span class="${t}">${e + 1}</span>`,
      },
      breakpoints: { 993: { slidesPerView: 3, pagination: !1 } },
    });
    const e = document.querySelectorAll('.section-steps .tab'),
      t = document.querySelector('.section-steps-slider');
    e.forEach((s) => {
      s.addEventListener('click', () => {
        e.forEach((e) => e.classList.remove('tab--active')), s.classList.add('tab--active');
        const a = s.getAttribute('data-target');
        t.setAttribute('data-type', a);
      });
    });
  });
